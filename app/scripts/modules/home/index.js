					...
					for (var j = 0; j < terArray.length; j++) {
						...
						if (ter.status == 0) {
							...
							marker = new BMap.Marker(tPoint, {
								icon: new BMap.Icon("img/zaixian.png", new BMap.Size(20, 25))
							});
							...
							marker = new BMap.Marker(tPoint, {
								icon: new BMap.Icon("img/lixian.png", new BMap.Size(20, 25))
							});
						} else if (ter.status == 3) {
							content.push("<div>状态：异常</div>");
							$scope.ter_error = $scope.ter_error + 1;
							marker = new BMap.Marker(tPoint, {
								icon: new BMap.Icon("img/yichang.png", new BMap.Size(20, 25))
							});
